"""
Predict Future Inclusive Growth Scores (IGS) - Frontend Copy

This is a copy of the prediction module optimized for frontend/Vercel deployment.
"""
...
# Paths configuration for frontend deployment
...
MODEL_PATH = os.path.join(BASE_DIR, 'model_predict_igs.joblib')
...
# Expected impact deltas for interventions
INTERVENTION_DELTAS = {
